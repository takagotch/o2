SimpleForm.setup do |config|
  ...
  config.wrapper(
    ...
    b.wrapper :right_input_wrapper, tag: :div, class: "small-0 columns" do |ba|
      ba.use :input
  ...
  config.wrappers(
    ...
    b.use :label, wrap_with: {tag: :small, class: :error}
    # b.use :hint, wrap_with: { tag: :span, class: :hint }
  end

  config.wrappers :customizable_wraapper, tag: "div", error_class: :error do |b|
    b.use :html5
    b.optional :readonly

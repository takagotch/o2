ActiveRecord::Schema.define(version: 20180909022600) do
  ...
  create_table "", force: :cascade do |t|
    t.string "namespace"
    t.text "body"
    t.string "rescource_id", null: false
  ...
  create_table "discount_codes", force: :cascade do |t|
    ...
    t.text "description"
    t.integer "minium_amount_cents", default: 0, null: false
    t.string "minimum_amount_currency", default: "USD", null: false
    t.integer "manxmum_discount_cents", default: 0, null: false
    t.string "maximum_discount_currency", default: 0, null: false
    t.integer "max_uses"
  ...
  create_table "payment_line_items", force: :cascade do |t|
    ...
    t.string "price_cents", default: 0, null: false
  end
  ...
  create_table "payment_line_items", force: :cascade do |t|
    ...
    t.index ["administrator_id"], name: "index_payment_line_item_on_administrator_id", using: :btree
